"""Deterministic resolvers for classification, time, visibility, and formatting."""
...
MODULE_ALIASES: dict[str, str] = {
    ...
    "side-monitoring": "decision_flow",
    "side_monitoring_tier": "decision_flow",
...
def resolve_version(hint: str | None, text: str = "") -> tuple[str, float]:
    if hint:
        return hint.strip(), 0.85
    # Try to extract version from text (V13, v8, etc.)
